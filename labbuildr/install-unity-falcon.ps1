    ...
    "import"
    {
        ...
        if (!($mastername))
		    ...
		    if ($vmwareversion.Major -eq 14)
			{
				...
				$Disk2 = $Template_VMX | Add-VMXScsiDisk -Diskname "$mastername-disk2.vmdk" -LUN 1 -Controller 0
				$Disk3 = $Template_VMX | Add-VMXScsiDisk -Diskname "$mastername-disk3.vmdk" -LUN 2 -Controller 0
