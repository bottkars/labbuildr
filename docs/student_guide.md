...
* [Prerequirements](https://github.com/bottkars/labbuildr/wiki/Student-Guide#01-prerequirements)
* [install and run labbuildr](https://github.com/bottkars/labbuildr/wiki/Student-Guide#10-install-and-run-labbuildr)  
* [defaults](https://github.com/bottkars/labbuildr/wiki/Student-Guide#12-adjusting-defaults)
* [Running VM´s](https://github.com/bottkars/labbuildr/wiki/Student-Guide#13-running-vms)    
...
```  
if the answer is "true", skip to [0.1.4 Execution Policy](https://github.com/bottkars/labbuildr/wiki/Student-Guide#014-execution-policy) 
...
``` 
if the answer is true, skip to step [0.1.3 Install Powershell](https://github.com/bottkars/labbuildr/wiki/Student-Guide#013-install-powershell-40) 
